...
const game = {
	...
	height: HEIGHT,
	players: [],
	const colors = [{name: "red", color: new Color(255,0,0)}, {name: "yellow", color: new Color(255,255,0)}, {name: "green", color: new Color(255, 255, 0)}, {name: "blue", color: new Color(0,0,255)}],
}
